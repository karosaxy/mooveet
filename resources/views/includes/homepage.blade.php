<div class="view" style="background-image: url('img/first.jpg');">
    ...
    <div class="mask rgba-gradient d-flex justify-content-center align-items-center">
        ...
        <div class="container d-flex">
            ...
            <div class="col-md-6 col-sm-12 text-white text-center text-md-left mt-xl-5 mb-5 wow fadeInLeft" data-wow-delay="0.3s">
                <h1 class="font-weight-bold mt-sm-5">Make your World go round</h1>
                <hr>
            ...
            <!--Grid column-->
            <!--Grid column-->
            <div class="col-xl-6 mt-xl-5 	d-none d-lg-block wow fadeInRight" data-wow-delay="0.3s">
